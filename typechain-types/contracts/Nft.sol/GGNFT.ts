...
export interface GGNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface GGNFT extends BaseContract {
  connect(runner?: ContractRunner | null): GGNFT;
  waitForDeployment(): Promise<this>;

  interface: GGNFTInterface;
